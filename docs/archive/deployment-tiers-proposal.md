# Historical deployment tiers proposal

> Archived on 14 September 2026. This proposal described unimplemented features as working, including zero-config path routing and a builtin keyword chatbot. It is not an operating procedure or capacity guarantee. See the [current deployment clarification](../../DEPLOY-TIERS.md) and [operations guide](../operations.md).
